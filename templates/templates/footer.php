...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Bonus: Change the icon when entering/exiting fullscreen
    ...
    function updateIcon() {
        if (document.fullscreenElement || document.webkitIsFullScreen || document.mozFullScreen || document.msFullscreenElement) {
            ...
            fullscreenIcon.classList.add('fa-compress'); // Change to compress icon
        } else {
            fullscreenIcon.classList.remove('fa-compress');
            fullscreenIcon.classList.add('fa-expand'); // Change back to expand icon
        }
    }
});
</script>
